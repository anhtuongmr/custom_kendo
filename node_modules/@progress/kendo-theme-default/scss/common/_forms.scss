...
@include exports("forms/layout") {
    ...
    .k-multiselect-wrap {
        ...
        .k-clear-value {
            ...
            line-height: ($form-line-height * $font-size );
            outline: 0;
            opacity: .5;
            cursor: pointer;
            display: none;
    ...
    .k-dropdown-wrap {
        ...
        .k-clear-value {
            right: calc( #{button-inner-size()} );

            .k-rtl &,
            [dir="rtl"] & {
                right: auto;
                left: calc( #{button-inner-size()} );
            }
        }
    }
    ...
    .k-multiselect-wrap {
        ...
        .k-i-loading,
        .k-clear-value {
            bottom: add-two($button-padding-y, $form-line-height * $font-size / 2);
        }
    }

    $input-icon-padding: calc(#{$input-padding-x} + #{$icon-size});
